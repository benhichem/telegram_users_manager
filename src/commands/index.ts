...
import AddBannedUser from "./addbanned.command.js";
...
export type commandsenum = "start_command" | 'users_list' | 'bulk_message' | 'bulk_remove' | 'bulk_add' | 'add_vip' | 'add_banned_user'